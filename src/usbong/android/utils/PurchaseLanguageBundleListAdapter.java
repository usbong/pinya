...
{
/*//commented out by Mike, 20160620
	private int languageBundleListSize=2; //default is 2
*/
	private int languageBundleListSize=1; //default is 1
	...
	public PurchaseLanguageBundleListAdapter(Activity a, Bundle ownedItems, IInAppBillingService mS)
	{
	    ...
	    languageBundleList[0][0] = "All Languages";
...
*/
	    ...
	    defaultSkuList.add(UsbongConstants.ALL_LANGUAGES_PRODUCT_ID);
/*//commented out by Mike, 20160620
...
*/			
	...
	*/			
		        ...
		        if (prefs!=null) {
					languageBundleList[0][1] = prefs.getString(UsbongConstants.ALL_LANGUAGES_PRODUCT_ID, UsbongConstants.DEFAULT_PRICE);
...
*/	    	  
	...
	public void setAllLanguagesToOwned() {
		languageBundleList[0][1] = "Owned";	
	}
